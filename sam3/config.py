...
def add_sam3_config(cfg):
    ...
    cfg.MODEL.VPT.QUERY_NUM_TOKENS = 0
    cfg.MODEL.VPT.QUERY_DIM = 256
    cfg.MODEL.VPT.QUERY_TEXT_DIM = 1536
    cfg.MODEL.VPT.QUERY_NUM_HEADS = 8
    cfg.MODEL.VPT.QUERY_DROPOUT = 0.1
