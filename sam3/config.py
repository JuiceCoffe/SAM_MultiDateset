...
def add_sam3_config(cfg):
    ...
    cfg.MODEL.SAM3.USE_PIXEL_PROJ = False
    ...
    cfg.MODEL.MAP_ADAPTER = CN()
    cfg.MODEL.MAP_ADAPTER.ENABLE = False
    cfg.MODEL.MAP_ADAPTER.NAME = "MAP_ADAPTER"
    cfg.MODEL.MAP_ADAPTER.FEAT_DIM = 4096
    cfg.MODEL.MAP_ADAPTER.NUM_ATTN_MAPS = 9
    cfg.MODEL.MAP_ADAPTER.MASK_IN_CHANNELS = 16
    cfg.MODEL.MAP_ADAPTER.NUM_CHANNELS = 768
    ...
    cfg.MODEL.VPT.NUM_PROMPTS_TO_INSERT = 200
    cfg.MODEL.VPT.START_LAYER = 1
    cfg.MODEL.VPT.END_LAYER = -1
